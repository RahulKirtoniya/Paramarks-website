...
/**
 * Interior page hero. Quiet by design — the full interactive seal is reserved
 * for the home page. Interior heroes let the headline carry the page, with only
 * a soft ambient glow and the gold rule for structure.
 */
